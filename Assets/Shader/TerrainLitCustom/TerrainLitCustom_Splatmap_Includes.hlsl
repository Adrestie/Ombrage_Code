// TerrainLitCustom_Splatmap_Includes.hlsl
// CBUFFER must match stock layout — terrain system fills it.
// Custom properties are declared OUTSIDE the CBUFFER in the splatmap file.
// -----------------------------------------------------------------------------------------
    ...
    #define _TERRAIN_BLEND_DENSITY
#endif

// -----------------------------------------------------------------------------------------
// Per-layer property declarations — STOCK ONLY (terrain system manages these)
// -----------------------------------------------------------------------------------------
