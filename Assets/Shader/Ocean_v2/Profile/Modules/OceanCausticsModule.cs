...
namespace Ombrage.OceanFeatures
{
    ...
    public class OceanCausticsModule : OceanFeatureModule
    {
        ...
        // NB : _OceanSunDirection ET _OceanWaterLevel sont poussés par OceanSurfaceModule (toujours actif),
        // pas ici — le module Caustics peut être absent alors que la surface/le sous-marin en ont besoin.
